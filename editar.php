				...
				<div class="container-fluid">
					...
					<nav aria-label="breadcrumb" role="navigation">
						<ol class="breadcrumb adminx-page-breadcrumb">
                            ...
                            <li class="breadcrumb-item"><a href="prop_info.php?id=<?php echo $id; ?>">Informações</a></li>
						...
						<div class="col-lg-6">
							<div class="card mb-grid">
								...
								<div class="card mb-grid">
									...
									<div class="card-body">
										<form method="POST" action="proc_editar_prop.php?id=<?php echo $row['id'];?>" id="needs-validation" novalidate >
											<div class="form-row">
												<div class="col-md-6 mb-3">
													<label class="form-label" for="validationCustom01">Nome</label>
													<input type="text" name="nome" class="form-control" id="validationCustom01" placeholder="Nome" value="<?php echo $row['nome'];?>" required>
												...
												<div class="col-md-6 mb-3">
													...
													<input type="text" name="sobrenome" class="form-control" id="validationCustom02" placeholder="Sobrenome" value="<?php echo $row['sobrenome'];?>" required>
													<div class="invalid-feedback">
														Campo Obrigatório
													</div>
												</div>
											...
											<div class="form-row">
												<div class="col-md-6 mb-3">
													...
													<input type="text" name="matricula" class="form-control" id="validationCustom03" placeholder="Matrícula" value="<?php echo $row['matricula'];?>" required>
													<div class="invalid-feedback">
														Campo Obrigatório
													</div>
												</div>
												<div class="col-md-6 mb-3">
													...
													<input class="form-control input-phone mb-2" name="telefone" type="text" id="validationCustom04" placeholder="Telefone" value="<?php echo $row['telefone'];?>" required>
													<div class="invalid-feedback">
														Campo Obrigatório
													</div>
												</div>
