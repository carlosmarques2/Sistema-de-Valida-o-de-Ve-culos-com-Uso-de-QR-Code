		...
		<div class="adminx-content">
			<div class="adminx-main-content">
				<div class="container-fluid">
					...
					<div class="pb-3">
						<h1>Editando Dados do Veículo</h1>
					</div>
					...
					<?php
                        $query =  "	SELECT *
									...
									ON veiculos.id_prop = proprietarios.id
									WHERE veiculos.id=? AND proprietarios.id=?;";

                        $resultado = $conn->prepare($query);
						
						$resultado->bindParam(1, $id[0]);
						$resultado->bindParam(2, $id[1]);
                        $resultado->execute();
							...
							<div class="card mb-grid">
								...
								<div class="card mb-grid">
									<div class="card-header">
										<div class="card-header-title">Edição</div>
									</div>
									<div class="card-body">
										<form method="POST" action="proc_editar_veic.php?id[]=<?php echo $id[0]."&id[]=".$id[1];?>" id="needs-validation" novalidate >
											<div class="form-row">
											...
											<div class="form-row">
												<div class="col-md-5 mb-3">
													...
													<input type="text" name="placa" class="form-control input-placa" id="validationCustom01" placeholder="Placa" value="<?php echo $row['placa'];?>" required>
												...
												<div class="col-md-4 mb-3">
													...
													<input type="text" name="modelo" class="form-control" id="validationCustom02" placeholder="Modelo" value="<?php echo $row['modelo'];?>" required>
													<div class="invalid-feedback">
														Campo Obrigatório
													</div>
												</div>
												<div class="col-md-3 mb-3">
													...
													<input type="text" name="cor" class="form-control" id="validationCustom03" placeholder="Cor" value="<?php echo $row['cor'];?>" required>
													<div class="invalid-feedback">
														Campo Obrigatório
													</div>
												</div>
